...
public class JdbcBookDaoTests extends BaseDaoTests {
    ...
    protected static final Book BOOK_1 = new Book("9781234567890", "title1", "author1", "description1", "format1", 0);
    protected static final Book BOOK_2 = new Book("9780987654321", "title2", "author2", "description2", "format2", 0);
    protected static final Book BOOK_3 = new Book("9785432109876", "title3", "author3", "description3", "format3", 0);
    ...
    public void created_book_has_expected_values_when_retrieved() {
        Book book = new Book("", "title4", "author4", "description4", "format4", 0);
